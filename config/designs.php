...
$heroSection = static function (
    ...
    $copy = [
        ...
        $patternText("{$id}-heading", 'heading', $headline, [
            'fontSize' => $patternKey === 'hero-editorial' ? 'clamp(2.5rem, 7cqw, 5.5rem)' : 'clamp(2rem, 5cqw, 4rem)',
            'fontFamily' => 'heading',
            'fontWeight' => '700',
            'lineHeight' => $patternKey === 'hero-editorial' ? '0.95' : '1.05',
            'letterSpacing' => '-0.035em',
            'textAlign' => $alignment,
            'maxWidth' => $patternKey === 'hero-centered' ? '16ch' : '18ch',
            'reveal' => 'fade-up',
        ]),
